...
Partial Class Login
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        ElseIf false Then 'isIPBlocked(logN) Then    ' disable block function by andrew 2014-12-01
            sucStr = "alert('Your login name is blocked by the system! Please contact the system admin.');"
        ...
        Else
            ...
            Elseif false Then
			'Else       ' disable block function by andrew 2014-12-01
                'Update IPTodayBlackList
                Dim ipAddress As String = logN              'getClientIP()
                ...
                If freq >= 3 Then
                    ...
                    If Not sqlResult2.HasRows Then
                        sql3 = "insert into IPBlackList (IP, LastDateTime, Remark, Active) values ('" & ipAddress & "', GetDate(), 'Login with incorrect username or password 3 times', 'True')"
                        conn_r3.Open()
