...
<body background="images/Bg-0064.jpg" bgcolor="#B6B6AA" text="#000000">
    ...
    <div>           
        <center>
            <table border="0" cellpadding="0" cellspacing="0" width="900">
                <tr>
                    ...
                    <td width="146"><img src="images/Nmark.gif" border="0" width="144" height="80" /></td>
                </tr>
            </table>
			<div style="width:900px; text-align:left">Provide by TBR Systems Limited.</div>
            <br/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="900">
                <tr><td width="300" class="TBox" valign="top">
                    ...
                    <td width="300" class="TBox" valign="Top">    
                                ...
                                <tr valign="top"><td>
                                        <table border="0" width="100%">    	                                    
                                            ...
                                            <tr><td width='100%' class="TBox" align="left">
			                                        Site Name: 
                                                    <asp:TextBox runat="server" ID="SerRepSiteName" MaxLength="100" TabIndex="10" CssClass="TBox" Width="100" onkeypress="javascript:submitSRSearch();"></asp:TextBox>&nbsp;
                                            ...
                                            <tr><td class="TBox" align="left" colspan="2" style="height: 20px"><a href="ServiceReport/JobDateList.aspx">Job Date List</a></td></tr>
											<tr><td class="TBox" align="left" colspan="2" style="height: 20px"><a href="ServiceReport/TravelFare.aspx">Travel Fare</a></td></tr>
										</table>
	                                </td></tr>
                            </table>
                        </div> 
						...
						<div id="LeaveRecordBox" runat="server" visible="false"><!-- Leave Record Box -->
                            <table border="1" width="300" height="100">
                                <tr align="left" valign="top"><td>
	                                <table border="0" width="100%">	                                        
	                                    <tr bgcolor="#add8e6"><th colspan="2">Leave Record</th></tr>
            	                                                    
	                                    <!-- Leave Record -->
	                                    <tr id="LeaveRecord" runat="server">
		                                    <td width='80%' class="TBox">
		                                        <a href="LeaveRecord/LeaveRecord.aspx">Leave Record</a></td></tr>
                                                
                                    </table></td></tr>
                            </table>
                        </div>
						
						<div id="ServicesBox" runat="server" visible="false"><!-- Services Box -->
                            <table border="1" width="300" height="100">
                                <tr align="left" valign="top"><td>
	                                <table border="0" width="100%">	                                        
	                                    <tr bgcolor="#add8e6"><th colspan="2">Services with clients</th></tr>
            	                                                    
	                                    <!-- Services -->
										<td width='80%' class="TBox">
		                                        <a href="webapp/addCategory.aspx">Add Category</a></td></tr>		
	                                    <tr>
		                                    <td width='80%' class="TBox">
		                                        <a href="webapp/addClient.aspx">Add clients</a></td></tr>
                                        <tr>
		                                    <td width='80%' class="TBox">
		                                        <a href="webapp/addprofile.aspx">Add Profile</a></td></tr>
										<tr>
		                                    <td width='80%' class="TBox">
		                                        <a href="webapp/ccscompanylist.aspx">Client List</a></td></tr>		
												<tr>
	                            ...
	                            <tr valign="top"><td class="TBox">
	                                <table border="0" width="100%" style="text-align:left">
				                       ...
				                       <tr id="NOPDReport" runat="server" visible="false">
											...
											<tr><td style="width:250px" class="TBox"><a href="SystemReport/CallSummary.aspx">Call Summary</a></td></tr>
			                        </table></td></tr>
                            </table>
                        </div>
                    </td></tr>               
        ...
        <center>
            <table border="0" cellpadding="0" cellspacing="0" width="900" id="blankReportTable" runat="server">
                ...
                <tr>
                    <td><asp:DropDownList ID="NoteList" runat="server" AutoPostBack="false">
                        ...
                        <asp:LinkButton ID="btnViewNMNote" runat="server" Text="Blank NM Note"></asp:LinkButton>&nbsp;&nbsp;&nbsp;
						<asp:LinkButton ID="LinkButton2" runat="server" Text="Blank YOOV Note" PostBackUrl="NoteReport/blankYOOV.aspx"></asp:LinkButton>&nbsp;&nbsp;&nbsp;
						<asp:LinkButton ID="LinkButton3" runat="server" Text="Blank TTSL Note" PostBackUrl="NoteReport/TTSLNote.aspx"></asp:LinkButton></td>
                    <td><asp:DropDownList ID="blankFormList" runat="server" AutoPostBack="false"></asp:DropDownList>
                        ...
                        &nbsp;&nbsp;&nbsp;
						<a href="document\Nationmark_ccs.apk" target="_blank" runat="server" id="TEST" >APP Download</a>
